...
export default function CountryDetails() {
  ...
  const fromBucketList = queryParams.get("from") === "bucketlist";
        ...
        <div className="flex flex-col items-center gap-4 w-full">
          <div className="w-11/12 sm:w-3/4 flex flex-col gap-2">
            {fromBucketList ? (
              <button
                onClick={() => navigate(-1)}
                className="w-full flex justify-center items-center bg-purple-600 hover:bg-purple-700 text-white font-semibold text-lg sm:text-xl px-6 py-3 rounded-md shadow transition"
              >
                Close
              </button>
            ) : (
