...
export default function Forum() {
  ...
  useEffect(() => {
    const loadPostedCountries = async () => {
      ...
      // Query all messages across all country forums where sender == user.email
      const q = query(
      ...
      // Extract unique country names from document paths
      const countriesSet = new Set<string>();
      snapshot.forEach((doc) => {
        // doc.ref.parent.parent?.id is the countryName (collection -> doc -> collection)
